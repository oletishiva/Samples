...
public class ReportsHelper extends BaseHelper {
	...
	public void setSASDBToDefault(Client client) {
	 ...
	 * Author: Devi
	 * 
	 * Set SASMode To Corrupt
	 * 
	 * @param client
	 *            Integrate SeeTestAutomation
	 * 
	 */
	public void setToSASModeToCorrupt(Client client) {
		openDebugDrawer(client);
		client.verifyElementFound("NATIVE",
	...
	//This method is not using for generalT006. we updated the setDateAndTime in Basehelper
	/**
	 * Author:Devi
	 * 
...
/*	public void setTheDate(Client client, String date, String month,
	...
	public void setTheDateAlone(Client client, String date, String month,
			String year, int additionalDay) {
		...
		String[] timeFromDevice=deviceTime.split(":");
		System.out.println("Hour============================" + timeFromDevice[0].split(" ")[1]);
		System.out.println("Minutes============================" +timeFromDevice[1]);
		
	
		Calendar c = Calendar.getInstance();
		
	
c.set(Calendar.HOUR_OF_DAY, Integer.parseInt(timeFromDevice[0].split(" ")[1]));
c.set(Calendar.MINUTE,Integer.parseInt(timeFromDevice[1]));
		c.set(Calendar.DATE, Integer.parseInt(date) + additionalDay);
		int mon = Integer.parseInt(month);
		System.out.println("=========" + mon);
		int month1 = mon - 1;
