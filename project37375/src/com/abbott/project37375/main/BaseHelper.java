...
public class BaseHelper {
	 ...
	 *            
	 */
	public void setToDefault(Client client) {
		client.sleep(1000);
		openDebugDrawer(client);
		client.verifyElementFound("NATIVE",
				"xpath=//*[@id='text1' and ./parent::*[@id='debug_sas_mode']]",
				0);
		String str0 = client.elementGetProperty("NATIVE",
				"xpath=//*[@id='text1' and ./parent::*[@id='debug_sas_mode']]",
				0, "text");
		if (!str0.equals("DEFAULT")) {
			client.click(
					"NATIVE",
					"xpath=//*[@id='text1' and ./parent::*[@id='debug_sas_mode']]",
					0, 1);
	 ...
	 * 
	 */
	//TODO we have to check after proper build release 
	...
	public void setValues() throws IOException, ParserConfigurationException, SAXException{
		...
		System.out.println("========="+configData[7]);
		setTextToSpeech(configData[8]);
		System.out.println("========="+configData[8]);
	...
	public void selectSkipForDebugging(Client client){
		client.waitForElement("NATIVE", "xpath=//*[contains(@text,'Update Date')]",0, 10000);
		if(client.isElementFound("NATIVE", "xpath=//*[contains(@text,'Update Date')]",0)){
			client.click("NATIVE", "text=SKIP FOR DEBUGGING!", 0, 1);
			waitFor(client,1);
		}
	}
	 ...
	 * 
	 */
	public void setNoError(Client client) {
		openDebugDrawer(client);
	...
	public void reLaunch(Client client) {
		client.launch(getapkPackage(), true, false);
		waitFor(client, 3);
	}
	...
	public void clickCreatedNote(Client client, String notetime) {
		...
		waitFor(client,2);
		if(!client.isElementFound("NATIVE", "xpath=//*[@id='value' and @text='"+notetime+"' and @class='android.support.v7.widget.AppCompatTextView']", 0)){
		...
		client.click("NATIVE", "text=" + notetime, 0, 1);
		waitFor(client,2);
	}
	...
	public void verifyExerciseIntensityInLogBookDetailPage(Client client,
		...
		if (minute.equals("0")) {
			if (hour.equals("1")) {
				...
				String abbrevDurationHrs_singular = getLangPropValue("abbrevDurationHrs_one");
				client.verifyElementFound("NATIVE",
			...
			if (minute.equals("1")) {
				...
				String abbrevDurationMins_singular = getLangPropValue("abbrevDurationMins_one");
				client.verifyElementFound("NATIVE",
						"xpath=//*[@id='lbdetail_note_description' and @text='${exercise} ${"
								+ intensity + "} ("
